#!/usr/bin/env bash
# _v15_finalize.sh — post-collect for the S105 V15 beach-fix render. Run AFTER
# cloud_bake/render_monitor.py has collected islands/_collect_v15/v15-b*.tgz.
#
...
# the previous render must not survive into ownership/assembly), and the V15
