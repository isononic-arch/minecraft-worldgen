#!/usr/bin/env bash
# _v17_finalize.sh — post-collect for the S105 V17 beach-fix render. Run AFTER
# cloud_bake/render_monitor.py has collected islands/_collect_v17/v17-b*.tgz.
#
...
# the previous render must not survive into ownership/assembly), and the V17
