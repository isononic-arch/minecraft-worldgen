#!/usr/bin/env bash
# S105 V16 FULL render — all 15 islands, 8 boxes (proven V7.1/V11 allocation,
...
# writes cloud_bake/runspec_v16.json — then EXITS. The poll/collect/verify/delete
...
TGZ="/tmp/rv_code.tgz"
COL="$ROOT/islands/_collect_v16"; mkdir -p "$COL"
...
NAME=(v16-b1 v16-b2 v16-b3 v16-b4 v16-b5 v16-b6 v16-b7 v16-b8)
...
spec = {
    "run_name": "v16", "kind": "islands",
    "ttl_min": 120, "wall_cap_min": 150,
    "stall_secs": 900, "poll_secs": 45, "collect_retries": 3, "unreach_grace": 4,
    "collect_dir": "islands/_collect_v16",
    "boxes": boxes,
}
out = ROOT/"cloud_bake"/"runspec_v16.json"
...
log "  \"$PY\" cloud_bake/render_monitor.py cloud_bake/runspec_v16.json"
