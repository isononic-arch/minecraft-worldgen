...
TGZ="/tmp/rv_code.tgz"
COL="$ROOT/islands/_collect_v9"; mkdir -p "$COL"
...
NAME=(v9-b1 v9-b2 v9-b3 v9-b4 v9-b5 v9-b6 v9-b7 v9-b8)
...
# ---- 5. safety sweep ----
rem=$(api "$API/servers" | "$PY" -c "import sys,json;[print(s['id']) for s in json.load(sys.stdin).get('servers',[]) if s['name'].startswith('v9-b')]" 2>/dev/null)
