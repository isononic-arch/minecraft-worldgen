...
**Current state:** Session 93→93e3 (2026-06-12) — **SHIPPED through `1007ce5` + new box snapshot `vandir-baked-s93` (396927540 — USE THIS, has S89 rock masks + v19 bed; old S86 snapshot lacks them → rock silently OFF on box renders). S93e3 organic taper: tube = inward EROSION of the spline polygon (dcl = hw − SDF; point-EDT tube read as a straight canal), furniture scaled to tube (banks/depth were paint-width-sized → trench), wobble floored at hw_min. FINAL2 box gates: true-wet connectivity 1 comp on ALL 6 tiles, estuary stable, rock live (9% surface on (79,71)). PENDING WALK. — READ [memory/S93_handoff.md](memory/S93_handoff.md) FIRST
